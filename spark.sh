...
options=$(getopt -o ihs: --long "install-hail help script: conda-env: hail-version: spark-module: spark-version: spark-interface: ipoib-domain: master-cores: scratch-dir:" -- "$@")
[ $? -eq 0 ] || {
  usage
