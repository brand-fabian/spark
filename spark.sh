...
options=$(getopt -o ihXs: --long "install-hail help no-use-srun script: conda-env: conda-module: hail-version: spark-module: spark-version: spark-interface: ipoib-domain: master-cores: scratch-dir: conda-init:" -- "$@")
[ $? -eq 0 ] || {
  usage
...
export SCRIPT_DIR=/home/fabrand_hpc/misc/spark
